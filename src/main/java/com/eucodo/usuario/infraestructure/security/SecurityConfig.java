package com.eucodo.usuario.infraestructure.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/usuario", "/usuario/").permitAll() // Permite acesso ao endpoint POST /usuario sem autenticação
